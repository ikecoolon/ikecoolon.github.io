 ...
 *
 * 分组小计（人日）：产品设计 2 / PC 管理端 14 / 小程序 6 / 后端 15 / 部署 5，合计 42 人日（336 人时）。
 * 含 20% 缓冲：8.4 人日（67.2 人时），总计 50.4 人日（403.2 人时，约 400 人时）。
 */
window.PROJECT_PROGRESS_DATA = {
  ...
  tasks: [
    ...
    // 前端 · PC 管理端（8 条，14 人日）
    { id: 'adm-01', lane: 'frontend', group: '前端 · PC 管理端', name: '管理端基础框架与登录', owner: '前端工程师', workdays: 1, startWeek: 2, endWeek: 2, progress: 0, status: 'not-started' },
    { id: 'adm-02', lane: 'frontend', group: '前端 · PC 管理端', name: '报告中心', owner: '前端工程师', workdays: 1.5, startWeek: 2, endWeek: 2, progress: 0, status: 'not-started', dependencyIds: ['adm-01'] },
    { id: 'adm-03', lane: 'frontend', group: '前端 · PC 管理端', name: 'Excel 导入与结果反馈', owner: '前端工程师', workdays: 1, startWeek: 3, endWeek: 3, progress: 0, status: 'not-started', dependencyIds: ['adm-02'] },
    { id: 'adm-04', lane: 'frontend', group: '前端 · PC 管理端', name: '报告工作台', owner: '前端工程师', workdays: 3, startWeek: 3, endWeek: 4, progress: 0, status: 'not-started', dependencyIds: ['adm-02'] },
    { id: 'adm-05', lane: 'frontend', group: '前端 · PC 管理端', name: '小程序实时预览与字段定位', owner: '前端工程师', workdays: 1, startWeek: 4, endWeek: 5, progress: 0, status: 'not-started', dependencyIds: ['adm-04'] },
    { id: 'adm-06', lane: 'frontend', group: '前端 · PC 管理端', name: '用户与宠物关联', owner: '前端工程师', workdays: 1.5, startWeek: 5, endWeek: 5, progress: 0, status: 'not-started', dependencyIds: ['adm-01'] },
    { id: 'adm-07', lane: 'frontend', group: '前端 · PC 管理端', name: '专业配置（字典/范围/规则/推荐）', owner: '前端工程师', workdays: 3, startWeek: 5, endWeek: 6, progress: 0, status: 'not-started', dependencyIds: ['adm-04'] },
    ...
    // 前端 · 小程序（5 条，6 人日）
    { id: 'mp-01', lane: 'frontend', group: '前端 · 小程序', name: '微信登录接入', owner: '前端工程师', workdays: 1, startWeek: 7, endWeek: 7, progress: 0, status: 'waiting' },
    { id: 'mp-02', lane: 'frontend', group: '前端 · 小程序', name: '宠物与报告入口', owner: '前端工程师', workdays: 1, startWeek: 7, endWeek: 7, progress: 0, status: 'not-started' },
    { id: 'mp-03', lane: 'frontend', group: '前端 · 小程序', name: '报告阅读', owner: '前端工程师', workdays: 2, startWeek: 7, endWeek: 8, progress: 0, status: 'not-started', dependencyIds: ['mp-02'] },
    { id: 'mp-04', lane: 'frontend', group: '前端 · 小程序', name: '健康建议与商城跳转', owner: '前端工程师', workdays: 1, startWeek: 8, endWeek: 8, progress: 0, status: 'not-started', dependencyIds: ['mp-03'] },
    { id: 'mp-05', lane: 'frontend', group: '前端 · 小程序', name: '微信环境适配与发布验证', owner: '前端工程师', workdays: 1, startWeek: 9, endWeek: 9, progress: 0, status: 'waiting', dependencyIds: ['mp-01'] },

    // 后端（9 条，15 人日）
    { id: 'be-01', lane: 'backend', group: '后端', name: '基础框架/鉴权/文件服务', owner: '后端工程师', workdays: 1.5, startWeek: 1, endWeek: 1, progress: 0, status: 'not-started' },
    { id: 'be-02', lane: 'backend', group: '后端', name: '用户宠物报告关联', owner: '后端工程师', workdays: 1.5, startWeek: 1, endWeek: 2, progress: 0, status: 'not-started', dependencyIds: ['be-01'] },
    { id: 'be-03', lane: 'backend', group: '后端', name: 'Excel 解析与导入', owner: '后端工程师', workdays: 2, startWeek: 2, endWeek: 2, progress: 0, status: 'not-started', dependencyIds: ['be-01'] },
    { id: 'be-04', lane: 'backend', group: '后端', name: '报告生命周期与草稿', owner: '后端工程师', workdays: 2, startWeek: 3, endWeek: 3, progress: 0, status: 'not-started', dependencyIds: ['be-02'] },
    { id: 'be-05', lane: 'backend', group: '后端', name: '字典/检测项/参考范围', owner: '后端工程师', workdays: 1.5, startWeek: 3, endWeek: 4, progress: 0, status: 'not-started', dependencyIds: ['be-01'] },
    { id: 'be-06', lane: 'backend', group: '后端', name: '分析规则与重新计算', owner: '后端工程师', workdays: 2, startWeek: 4, endWeek: 4, progress: 0, status: 'not-started', dependencyIds: ['be-05'] },
    { id: 'be-07', lane: 'backend', group: '后端', name: '推荐映射', owner: '后端工程师', workdays: 1, startWeek: 5, endWeek: 5, progress: 0, status: 'not-started', dependencyIds: ['be-05'] },
    { id: 'be-08', lane: 'backend', group: '后端', name: '审核发布更正作废追溯', owner: '后端工程师', workdays: 2, startWeek: 5, endWeek: 6, progress: 0, status: 'not-started', dependencyIds: ['be-04'] },
    { id: 'be-09', lane: 'backend', group: '后端', name: '小程序查询接口', owner: '后端工程师', workdays: 1.5, startWeek: 6, endWeek: 6, progress: 0, status: 'not-started', dependencyIds: ['be-02'] },
    ...
    { id: 'ops-04', lane: 'deploy', group: '部署', name: '联调与回归', owner: '全员', workdays: 1, startWeek: 8, endWeek: 8, progress: 0, status: 'not-started', dependencyIds: ['ops-03'] },
  ...
  prerequisites: [
    {
      ...
      affectedTaskIds: ['mp-01', 'mp-05', 'ops-04']
    },
    {
      ...
      affectedTaskIds: ['mp-01', 'mp-05', 'ops-06']
    },
    {
      id: 'pre-mp-members',
      title: '开发者与体验成员权限',
      ...
      affectedTaskIds: ['mp-05', 'ops-04', 'ops-06']
    },
    {
      id: 'pre-mp-category',
      title: '服务类目与专项资质确认',
      ...
      affectedTaskIds: ['mp-02', 'mp-03', 'mp-05', 'ops-06']
    },
    {
      id: 'pre-mp-filing',
      title: '小程序备案',
    ...
    },
    {
      ...
      sourceLabel: '微信开放文档：网络',
      sourceUrl: 'https://developers.weixin.qq.com/miniprogram/dev/framework/ability/network.html',
      affectedTaskIds: ['mp-01', 'mp-02', 'mp-03', 'mp-04', 'mp-05', 'ops-02', 'ops-04']
    },
    {
      id: 'pre-mp-privacy',
      ...
      affectedTaskIds: ['mp-01', 'mp-02', 'mp-03', 'mp-05', 'ops-06']
    },
    {
      id: 'pre-mp-review',
      ...
      affectedTaskIds: ['mp-02', 'mp-03', 'mp-05', 'ops-04', 'ops-06']
    },
    {
      id: 'pre-pay-path',
      title: '商城支付承接方式确认',
      ...
      affectedTaskIds: ['mp-04', 'mp-05', 'ops-04', 'ops-06']
    },
    {
      id: 'pre-pay-merchant',
      ...
      sourceLabel: '微信支付：开发接入准备',
      sourceUrl: 'https://pay.wechatpay.cn/doc/v3/merchant/4015459512',
      affectedTaskIds: ['mp-04', 'mp-05', 'ops-04']
    },
    {
      ...
      affectedTaskIds: ['mp-04', 'mp-05', 'ops-04', 'ops-05']
    },
    {
      ...
      affectedTaskIds: ['mp-04', 'mp-05', 'ops-04', 'ops-05', 'ops-06']
    }
  ],
  pendingScopes: [
